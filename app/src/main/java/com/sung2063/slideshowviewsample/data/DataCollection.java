...
public class DataCollection {
    ...
    public static List<MainOptionModel> getMainOptionData(Context context) {
        ...
        List<MainOptionModel> mainOptionList = new ArrayList<MainOptionModel>();
    ...
    public static List<HorizontalCarouselModel> getHorizontalCarouselData(Context context) {
        ...
        List<HorizontalCarouselModel> horizontalCarouselList = new ArrayList<HorizontalCarouselModel>();
    ...
    public static List<Integer> getVerticalCarouselData() {
        ...
        List<Integer> verticalCarouselList = new ArrayList<Integer>();
    ...
    public static List<Integer> getSlideshowData() {
        ...
        List<Integer> slideshowList = new ArrayList<Integer>();
